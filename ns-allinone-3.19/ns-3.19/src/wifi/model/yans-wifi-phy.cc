...
YansWifiPhy::Configure80211b (void)
{
  ...
  m_deviceRateSet.push_back (WifiPhy::GetDsssWakeupRate10Kbps ()); //JJH 0527
  m_deviceRateSet.push_back (WifiPhy::GetDsssWakeupRate50Kbps ()); //JJH 0527
  m_deviceRateSet.push_back (WifiPhy::GetDsssWakeupRate100Kbps ()); //JJH 0527
  m_deviceRateSet.push_back (WifiPhy::GetDsssWakeupRate200Kbps ()); //JJH 0527
  m_deviceRateSet.push_back (WifiPhy::GetDsssMainRate250Kbps ()); //JJH 0526
}
