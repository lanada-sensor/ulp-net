...
//  SetEifsNoDifs (MicroSeconds (10 + 304));
  SetEifsNoDifs (MicroSeconds (10 + 30400)); //JJH 0527 for low data rate
...
//  SetAckTimeout (MicroSeconds (10 + 304 + 20 + GetDefaultMaxPropagationDelay ().GetMicroSeconds () * 2));
  SetCtsTimeout (MicroSeconds (10 + 30400 + 20 + GetDefaultMaxPropagationDelay ().GetMicroSeconds () * 2));
  SetAckTimeout (MicroSeconds (10 + 30400 + 20 + GetDefaultMaxPropagationDelay ().GetMicroSeconds () * 2)); //JJH 0527 for low data rate
}
