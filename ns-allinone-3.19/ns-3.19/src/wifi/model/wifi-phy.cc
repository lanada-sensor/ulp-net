...
WifiMode
WifiPhy::GetDsssWakeupRate10Kbps ()
{
  static WifiMode mode =
    WifiModeFactory::CreateWifiMode ("DsssWakeupRate10Kbps",
                                     WIFI_MOD_CLASS_DSSS,
                                     true,
                                     22000000, 10000,
...
WifiMode
WifiPhy::GetDsssWakeupRate50Kbps ()
{
  static WifiMode mode =
    WifiModeFactory::CreateWifiMode ("DsssWakeupRate50Kbps",
                                     WIFI_MOD_CLASS_DSSS,
                                     true,
                                     22000000, 50000,
                                     WIFI_CODE_RATE_UNDEFINED,
...
WifiMode
WifiPhy::GetDsssWakeupRate100Kbps ()
{
  static WifiMode mode =
    WifiModeFactory::CreateWifiMode ("DsssWakeupRate100Kbps",
                                     WIFI_MOD_CLASS_DSSS,
                                     true,
                                     22000000, 100000,
                                     WIFI_CODE_RATE_UNDEFINED,
...
WifiMode
WifiPhy::GetDsssWakeupRate200Kbps ()
{
  static WifiMode mode =
    WifiModeFactory::CreateWifiMode ("DsssWakeupRate200Kbps",
                                     WIFI_MOD_CLASS_DSSS,
                                     true,
                                     22000000, 200000,
                                     WIFI_CODE_RATE_UNDEFINED,
...
WifiMode
WifiPhy::GetDsssMainRate250Kbps ()
{
  static WifiMode mode =
    WifiModeFactory::CreateWifiMode ("DsssMainRate250Kbps",
                                     WIFI_MOD_CLASS_DSSS,
                                     true,
                                     22000000, 250000,
                                     WIFI_CODE_RATE_UNDEFINED,
...
public:
  Constructor ()
  {
	  ns3::WifiPhy::GetDsssWakeupRate10Kbps ();
	  ns3::WifiPhy::GetDsssWakeupRate50Kbps ();
	  ns3::WifiPhy::GetDsssWakeupRate100Kbps ();
	 ns3::WifiPhy::GetDsssWakeupRate200Kbps ();
	 ns3::WifiPhy::GetDsssMainRate250Kbps ();
