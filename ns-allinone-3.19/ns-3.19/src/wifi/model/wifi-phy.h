...
/** 
  ...
  */
  ...
  /**
    *  JJH 0527
     * Rate test DSSS Wakeup radio Rate 100Kbps
      *
      *
      */
   static WifiMode GetDsssWakeupRate10Kbps ();
    ...
    *  JJH 0527
     * Rate test DSSS Wakeup radio Rate 100Kbps
      ...
      *
      */
   static WifiMode GetDsssWakeupRate50Kbps ();
    ...
    *  JJH 0527
     * Rate test DSSS Wakeup radio Rate 100Kbps
      ...
      *
      */
   static WifiMode GetDsssWakeupRate100Kbps ();
    ...
    *  JJH 0527
     * Rate test DSSS Wakeup radio Rate 100Kbps
      ...
      *
      */
   static WifiMode GetDsssWakeupRate200Kbps ();


   /**
    *  JJH 0526
     * Rate test DSSS Main radio Rate 250Kbps
      *
      *
      */
   static WifiMode GetDsssMainRate250Kbps ();
  /**
